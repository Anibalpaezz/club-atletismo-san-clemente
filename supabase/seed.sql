...
-- Noticias
-- ------------------------------------------------------------
insert into public.noticias (slug, titulo, resumen, cuerpo, fecha_publicacion, publicado) values
(
  'abierta-la-inscripcion-de-la-10k-nocturna-villa-de-san-clemente',
...
(
  'el-club-participa-en-el-circuito-provincial-de-carreras-populares-de-la-diputacion-de-cuenca',
