import { $ as AstroError, C as InvalidImageService, H as RemoteImageNotAllowed, c as ExpectedImageOptions, l as ExpectedNotESMImage, s as ExpectedImage } from "./errors-data_B1kPcZIy.mjs";
import { i as isRemoteAllowed, t as inferRemoteSize } from "./remoteProbe_D0GFWKh4.mjs";
import { a as isESMImportedImage, i as resolveDefaultOutputFormat, n as isLocalService, o as isRemoteImage, s as resolveSrc } from "./service_ZKdxbG00.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_C1ShXtUm.mjs").catch((e) => {
